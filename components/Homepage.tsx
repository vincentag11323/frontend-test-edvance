...
export default function Homepage({movies} : {movies: PaginatedResponse<MovieDetail>}){
  ...
  const searchParams = useSearchParams();
    const [sortValue, setSortValue] = useState( searchParams.get('sort') ||  'release_date.desc');
  ...
  // Get the current sort value from the URL, or use a default
    ...
    }, [page, sortValue, totalPages, isPending, data, setPage, startTransition, setData, setTotalPages])
